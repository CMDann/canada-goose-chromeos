var style_sheets = ["<link href='css/plain.css' rel='stylesheet'>",
                    "<link href='css/forest.css' rel='stylesheet'>"];

style_sheets = style_sheets[Math.floor(Math.random()*style_sheets.length)];
$('head').append(style_sheets);
